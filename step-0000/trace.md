...
_start      0x08049020 fc             cld
            ...
            0x08049029 be 14 a0 04 08 mov    $0x804a014,%esi
...
$pc => 0x8049021 <_start+1>:	push   $0x0
$eax 0x00000000
$esi 0x00000000
...
$pc => 0x8049023 <_start+3>:	push   $0x0
$eax 0x00000000
$esi 0x00000000
...
$pc => 0x8049025 <_start+5>:	push   $0x0
$eax 0x00000000
$esi 0x00000000
...
$pc => 0x8049027 <_start+7>:	push   $0x0
$eax 0x00000000
$esi 0x00000000
...
$pc => 0x8049029 <_start+9>:	mov    $0x804a014,%esi
$eax 0x00000000
$esi 0x00000000
...
$pc => 0x804902e <_start+14>:	lods   %ds:(%esi),%eax
$eax 0x00000000
...
$pc => 0x804902f <_start+15>:	jmp    *(%eax)
$eax 0x0804a000  LIT
...
$pc => 0x8049000 <code_LIT>:	lods   %ds:(%esi),%eax
$eax 0x0804a000  LIT
$esi 0x0804a018  cold_start + 4
$esp 0xffffca30:	0	0	0	0
--------------------
...
$pc => 0x8049001 <code_LIT+1>:	push   %eax
$eax 0x00000002
...
$pc => 0x8049002 <code_LIT+2>:	lods   %ds:(%esi),%eax
$eax 0x00000002
$esi 0x0804a01c  cold_start + 8
...
$pc => 0x8049003 <code_LIT+3>:	jmp    *(%eax)
$eax 0x0804a000  LIT
...
$pc => 0x8049011 <code_ADD+1>:	add    %eax,(%esp)
$eax 0x00000003
$esi 0x0804a028  cold_start + 20
$esp 0xffffca2c:	2	0	0	0
--------------------
...
$pc => 0x8049014 <code_ADD+4>:	lods   %ds:(%esi),%eax
$eax 0x00000003
$esi 0x0804a028  cold_start + 20
...
$pc => 0x8049015 <code_ADD+5>:	jmp    *(%eax)
$eax 0x0804a010  BYE
$esi 0x0804a02c
$esp 0xffffca2c:	5	0	0	0
--------------------
...
$pc => 0x8049017 <code_BYE>:	xor    %ebx,%ebx
$eax 0x0804a010  BYE
$esi 0x0804a02c
$esp 0xffffca2c:	5	0	0	0
--------------------
...
$pc => 0x8049019 <code_BYE+2>:	mov    $0x1,%eax
$eax 0x0804a010  BYE
$esi 0x0804a02c
$esp 0xffffca2c:	5	0	0	0
--------------------
...
$pc => 0x804901e <code_BYE+7>:	int    $0x80
$eax 0x00000001
$esi 0x0804a02c
$esp 0xffffca2c:	5	0	0	0
--------------------
